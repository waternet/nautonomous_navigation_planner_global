...
def convert_GPS_coordinate_to_UTM_position(lat, lon):
	return utm.from_latlon(lat, lon)[:2] # only use the first two elements of the tuple: easting and northing (in that order)